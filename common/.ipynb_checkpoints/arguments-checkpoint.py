...
def parse_args():
    ...
    parser.add_argument('-t', '--t_length', default=1, type=int, metavar='N', help='length of sequence')
    ...
    parser.add_argument('--checkpoint', default='multi_view_4_mpjpe_att_tran_conf_T1.bin', type=str,  help='path to checkpoint')
